...
cmd="fairseq-train $st_dir --source-lang $SRC --target-lang $TGT \
    ...
    --bpe-dropout 0.1  \
    --arch pos_relative_s --dropout 0.3 --activation-dropout 0.1 \
...
name=transformer_offline_m32r16
cmd="fairseq-train $st_dir --source-lang $SRC --target-lang $TGT \
    --encoder-max-relative-position 32 \
    --max-epoch 100 \
    --user-dir rain
...
name=transformer_offline_m16r16
cmd="fairseq-train $st_dir --source-lang $SRC --target-lang $TGT \
    --encoder-max-relative-position 32 \
    --max-epoch 100 \
    --user-dir rain
    ...
    --task s2s --task-type st \
    --bpe-dropout 0.1  \
    --main-context 16 --right-context 16 \
    --arch online_audio_transformer_offline --dropout 0.3 --activation-dropout 0.1 \
    --share-decoder-input-output-embed \
    --share-all-embeddings   \
    --optimizer adam --adam-betas '(0.9, 0.98)' \
...
cmd="fairseq-train $st_dir --source-lang $SRC --target-lang $TGT \
    ...
    --task s2s --task-type st \
    --bpe-dropout 0.1  \
    --main-context 4 --right-context 0 \
    --arch online_audio_transformer_offline --dropout 0.3 --activation-dropout 0.1 \
    --share-decoder-input-output-embed \
    --share-all-embeddings   \
    --optimizer adam --adam-betas '(0.9, 0.98)' \
...
cmd="fairseq-train $st_dir --source-lang $SRC --target-lang $TGT \
    ...
    --task s2s --task-type st \
    --bpe-dropout 0.1  \
    --arch audio_cat_offline --dropout 0.3 --activation-dropout 0.1 \
    --share-decoder-input-output-embed \
    --share-all-embeddings   \
    --optimizer adam --adam-betas '(0.9, 0.98)' \
    --lr 0.0005 --lr-scheduler inverse_sqrt  \
